  ...
  useEffect(() => {
    const handleAccept = async () => {
      try {
        ...
        const response = await fetch(`/api/jobs/application/${params.applicationId}/accept`, {
          method: 'POST',
          headers: {
        ...
        setError(error instanceof Error ? error.message : 'Failed to accept application')
        setStatus('error')
      }
    }
        ...
        <CardContent className="space-y-4">
          {status === 'loading' && (
            <div className="text-center">
              ...
              <p className="mt-4">Processing your acceptance...</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                You have successfully accepted this application. An email has been sent to connect both parties.
              </p>
